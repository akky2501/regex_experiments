...
public:
    ...
    :lex("")
    {
		...
		//std::cout << std::endl;
		//
		Node* a = new Node(opChar,'a',nullptr,nullptr);
		Node* aS = new Node(opClosure,a,nullptr);
		Node* b = new Node(opChar,'b',nullptr,nullptr);
		root = new Node(opConnect,aS,b);
...
int main(int argc,char* argv[]){
	...
	bool result = re.match(argv[2]);
	
	printf("D\n%s %s",argv[2],(result?"T":"F"));
